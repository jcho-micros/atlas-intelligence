...
class Keyword(Base):
    ...
    runs = relationship("ResearchRun", back_populates="keyword")
    listings = relationship("Listing", back_populates="keyword")
    opportunity = relationship("Opportunity", back_populates="keyword", uselist=False)
