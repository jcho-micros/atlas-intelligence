...
class OpportunityService:
    ...
    def calculate_for_keyword(self, keyword: Keyword) -> Opportunity:
        ...
        raw_score = demand_score * 0.35 + profit_score * 0.30 + personalization_score * 0.20 + digital_bonus - competition_score * 0.15
        ...
        notes = (
            f"{listing_count} listings; avg ${avg_price}; avg views {round(avg_views)}; "
            f"avg favorites {round(avg_favorites)}; {personalized_count} personalized; {digital_count} digital"
        )
